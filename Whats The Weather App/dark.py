...
def get_data():
    try:
        ...
        if city.isdigit():
            ...
            api_key1 = "http://api.openweathermap.org/data/2.5/weather?q="
            api_key2 = "&appid=0aa1585fe404fe991c26a0ecb44364bd"
            api = api_key1 + city + api_key2
...
def about():
    ...
    yt_video_link = "https://youtu.be/oHjFnGGIIOI"
...
button_3 = Button(image=button_image_3, borderwidth=0, highlightthickness=0, command=toggle_theme, relief="flat",
